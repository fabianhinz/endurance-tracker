...
const tss: MetricExplanation = {
  ...
  oneLiner: 'Measures how hard a workout was relative to your personal threshold.',
  fullExplanation:
...
const trimp: MetricExplanation = {
  ...
  oneLiner: 'Estimates workout stress from heart rate data using the Banister formula.',
  fullExplanation:
...
const atl: MetricExplanation = {
  ...
  oneLiner: 'How much training stress you have accumulated over the past ~week.',
  fullExplanation:
...
const gradeAdjustedPace: MetricExplanation = {
  ...
  oneLiner: 'Your equivalent flat-ground pace, adjusted for hills using metabolic cost modeling.',
  fullExplanation:
...
const trainingZones: MetricExplanation = {
  ...
  name: 'Training Zones',
  oneLiner: 'Pace-based intensity zones derived from your threshold pace.',
  fullExplanation:
...
const aerobicTE: MetricExplanation = {
  ...
  oneLiner: 'How much this session improved your aerobic endurance, on a 0–5 scale.',
  fullExplanation:
...
const avgSpeed: MetricExplanation = {
  ...
  name: 'Average Speed',
  oneLiner: 'Your average speed in km/h, the primary intensity metric for cycling.',
  fullExplanation:
...
const avgPower: MetricExplanation = {
  ...
  name: 'Average Power',
  oneLiner: 'The mean power output across the session, measuring raw mechanical work.',
  fullExplanation:
...
const elevation: MetricExplanation = {
  ...
  oneLiner: 'Total meters climbed and descended during the session.',
  fullExplanation:
...
const cadence: MetricExplanation = {
  ...
  oneLiner: 'Your average steps or revolutions per minute during the session.',
  fullExplanation:
