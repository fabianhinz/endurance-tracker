...
- **Engine, Packages & Lib** (`src/packages/engine/`, `src/packages/*/`, `src/lib/`): Tests are required for _every_ change. You must cover the happy path, edge cases, and error conditions.
